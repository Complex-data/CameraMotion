...
name = strcat('000000000', num2str(index), '.png');

if index < 10
    name = strcat('000000000', num2str(index), '.png');
elseif index >= 10 && index <= 99
    name = strcat('00000000', num2str(index), '.png');
elseif index >= 100 && index <= 999
    name = strcat('0000000', num2str(index), '.png');
elseif index >= 1000 && index <= 9999
    name = strcat('000000', num2str(index), '.png');
end
