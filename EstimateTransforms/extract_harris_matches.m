...
tic
for k = 1:10
%     I1p = imread(['../ImageData/LeftData/', num2str(k, '%.6d'), '.png']);
%     I1c = imread(['../ImageData/LeftData/', num2str(k + 1, '%.6d'), '.png')]);
% 
...
%     left.m1c{k} = m1c;
    ...
    I2p = imread(['../ImageData/RightData/', num2str(k, '%.6d'), '.png']);
    I2c = imread(['../ImageData/RightData/', num2str(k + 1, '%.6d'), '.png']);
