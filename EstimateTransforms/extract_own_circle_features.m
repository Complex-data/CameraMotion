...
I1p = imread(['..\ImageData\LeftData\', num2str(4, '%.6d'), '.png']);
I2p = imread(['..\ImageData\RightData\', num2str(4, '%.6d'), '.png']);

I1c = imread(['..\ImageData\LeftData\', num2str(5, '%.6d'), '.png']);
I2c = imread(['..\ImageData\RightData\', num2str(5, '%.6d'), '.png']);
...
uv1c = vp1c(indCircFeat(1:nCircFeat, 1), 1:2);
uv1p = vp1p(indCircFeat(1:nCircFeat, 2), 1:2);
uv2p = vp2p(indCircFeat(1:nCircFeat, 3), 1:2);
uv2c = vp2c(indCircFeat(1:nCircFeat, 4), 1:2);
toc

%%
figure(1);
showMatchedFeatures(I1p, I1c, uv1p, uv1c);